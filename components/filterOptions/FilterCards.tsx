...
export default function FilterCards(props: any) {
    ...
    const [carouselIndex, setCarouselIndex] = React.useState(9)
    ...
    let optionsArray = [
        ...
        {   title: 'Competitive Skill', 
            ...
            url: "https://www.active.com/Assets/active-family/460+x+345/drill-of-the-week-running-form-drill-for-kids.jpg"
        },
        ...
        {   title: 'Accessibility', 
            ...
            url: "https://images-na.ssl-images-amazon.com/images/I/61PjCWgdkbL._AC_SL1500_.jpg"
        },
        ...
        {   title: 'Cost', 
            ...
            url: "https://icdn.dtcn.com/image/newfolks/lemonade-stand-1.jpg"
        }
        ];
...
function FilterCardsCarousel(props: any) {
    //console.log("Props at Filter Cards: " + Object.keys(props))
    ...
    function renderCrouselItem({item, index}){
